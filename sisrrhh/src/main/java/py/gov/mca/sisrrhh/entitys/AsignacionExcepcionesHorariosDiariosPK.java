 ...
 */
@Embeddable
public class AsignacionExcepcionesHorariosDiariosPK implements Serializable {
    ...
    public String toString() {
        return "py.gov.mca.sisrrhh.entitys.AsignacionExcepcionesHorariosDiariosPK[ codigoExcepcion=" + codigoExcepcion + ", fechaAsignacion=" + fechaAsignacion + ", numeroDocumentoFuncionario=" + numeroDocumentoFuncionario + " ]";
    }
